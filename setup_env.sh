...
# Editable install of this repo's own harness package (rlsdc/), so any script
# can `import rlsdc` regardless of working directory, with no sys.path hacks.
echo "[setup] installing rlsdc harness package (editable)"
